...
// MaxLinearBlurSigma is the largest sigma handled by a single 1D linear-filtered pass (radius 27 → linear kernel width
// 28). Larger sigmas must be downscaled before such a pass runs.
